...
- **系统托盘**：窗口可最小化到系统托盘；通过托盘菜单（或左键单击托盘图标）显示 / 隐藏窗口，托盘提供"退出"彻底关闭程序。**关闭窗口是隐藏到托盘而不是退出**；托盘菜单文案会随界面中英切换自动同步。
...
- 窗口关闭（或被最小化到托盘）后，程序仍在**系统托盘**后台运行。左键单击托盘图标可显示 / 隐藏窗口；右键托盘图标弹出 **显示 / 隐藏** 与 **退出** 菜单，使用"退出"才彻底关闭程序。
